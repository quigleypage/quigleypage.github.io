...
function addNewNote(className, title, content) {
    ...
    notes.append("<li><div class='" + className + "'>" + 
                    ...
                    "<textarea class='note-content' placeholder='Write a note..'/>" + 
...
// load the notes saved in the local storage
function clearNotes() {
    var storedNotes = localStorage.removeItem("notes");
    location.reload();
}
...
$(document).ready(function () {
    ...
    $("#btnNew").click(function () {
        addNewNote("colour-white");
    });
    $("#btnNew-yellow").click(function () {
        addNewNote("colour-yellow");
    });
    $("#btnNew-green").click(function () {
        addNewNote("colour-green");
    });
    $("#btnNew-blue").click(function () {
        addNewNote("colour-blue");
    });
    $("#btnNew-purple").click(function () {
        addNewNote("colour-purple");
    });
