        ...
        document.getElementById('startButton').addEventListener('click', () => {
          codeReader.decodeFromVideoDevice(selectedDeviceId, 'video', (result, err) => {
            if (result) {
              ...
              document.getElementById('ebaySaleLink').innerHTML = "<a href='https://www.ebay.com/sch/i.html?_nkw=" + result.text + "' target='_blank'>Ebay - for Sale</a>";
              document.getElementById('ebaySoldsLink').innerHTML = "<a href='https://www.ebay.com/sch/i.html?_nkw=" + result.text + "&LH_Sold=1&LH_Complete=1&LH_ItemCondition=3' target='_blank'>Ebay - Solds</a>";
